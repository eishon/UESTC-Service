...
public class MenuLanguageTabFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new CommonDialoguesFragment();
                case 1 : return new FoodMenuFragment();
                case 2 : return new ChieneseHistoryFragment();
            }
            return null;
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position){
                case 0 :
                    return "Common Dialogues";
                case 1 :
                    return "Food Menu";
                case 2 :
                    return "Chienese History";
            }
            return null;
        }
    }
