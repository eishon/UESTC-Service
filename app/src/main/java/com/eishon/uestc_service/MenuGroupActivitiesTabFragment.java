...
public class MenuGroupActivitiesTabFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new ISUFragment();
                case 1 : return new CountryRepsFragment();
                case 2 : return new COSAFragment();
                case 3 : return new QQGroupsFragment();
            }
            return null;
        }
