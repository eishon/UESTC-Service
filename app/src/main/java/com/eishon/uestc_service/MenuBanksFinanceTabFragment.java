...
public class MenuBanksFinanceTabFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new BankCommunicationsFragment();
                case 1 : return new BankChinaFragment();
                case 2 : return new AlipayFragment();
                case 3 : return new WechatWalletFragment();
            }
            return null;
        }
